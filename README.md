...
BIP39 Mnemonics for bitcore-lib-zcash
=======
...
A module for [bitcore-lib-zcash](https://github.com/str4d/bitcore-lib-zcash) that implements [Mnemonic code for generating deterministic keys](https://github.com/bitcoin/bips/blob/master/bip-0039.mediawiki).
...
```sh
npm install bitcore-mnemonic-zcash
bower install bitcore-mnemonic-zcash
```

There are many examples of how to use it on the developer guide [section for mnemonic](http://bitcore.io/guide/module/mnemonic/index.html). For example, the following code would generate a new random mnemonic code and convert it to a `HDPrivateKey`.

```javascript
var Mnemonic = require('bitcore-mnemonic-zcash');
